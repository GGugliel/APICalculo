...
namespace APICalculo.Model {
  ...
  public class UnidadeFederacao {
    ...
    /// <summary>
    /// informação do Estado referente ao endereço do risco
    /// </summary>
    /// <value>informação do Estado referente ao endereço do risco</value>
    [DataMember(Name="SiglaUF", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SiglaUF")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class UnidadeFederacao {\n");
      sb.Append("  PxObjClass: ").Append(PxObjClass).Append("\n");
      sb.Append("  SiglaUF: ").Append(SiglaUF).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
